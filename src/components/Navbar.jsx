    ...
    <>
     <div className="w-full bg-inherit flex justify-between items-center p-4 shadow-sm text-white">
        ...
        <div className='flex gap-8'>
           ...
           <a href="https://zahid40.github.io/"><img src="https://lh3.googleusercontent.com/a/ACg8ocJxADMIkIBvfexyntm-vXTsASjSikBYNQoM5X-Lta8KIB4=s96-c" className='rounded-full w-6' alt="" /></a>
        </div>
     </div>
    </>
  )
